    ...
    <div className="align-items-end bg-17 flex-column">
	      <div className="d-flex p-2 flex-column flex-lg-row">
	        ...
	        <div className="d-flex align-items-center col flex-column">
	          <h5 className="d-flex justify-content-center jacques-francois-regular f-20"><strong>Useful Links</strong></h5>
	        ...
	        <div className="d-flex align-items-center col flex-column">
	          <h5 className="d-flex justify-content-center jacques-francois-regular f-20"><strong>Contact Us</strong></h5>
	          <h6 className="pt-serif-regular"> gillydecastro@gmail.com</h6>
	          <h6 className="pt-serif-regular"> 09634112627</h6>
	          <h6 className="pt-serif-regular"> Gilly Jean De Castro</h6>
	          <h6 className="pt-serif-regular"> Tublijon Juban Sorsogon</h6>
	        </div>
	    </div>
