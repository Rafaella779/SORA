				...
				<div className="d-flex w-600 h-3">	
					...
					<div>
						...
						<div>
							...
							<p className="m-1 p-1"> <strong>Educational Degree</strong> {localStorage.getItem('n')}</p>
							<p className="m-1 p-1"> <strong>No. of research</strong> {localStorage.getItem('n')}</p>	
						</div>
					</div>
				</div>
			</div>
